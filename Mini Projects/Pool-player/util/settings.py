...
POCKET_LOCATION = (np.array([(SIDE_POCKET_DIST, SIDE_POCKET_DIST), (WIDTH // 2, CENTER_POCKET_DIST), (WIDTH - SIDE_POCKET_DIST, SIDE_POCKET_DIST), (SIDE_POCKET_DIST, HEIGHT - SIDE_POCKET_DIST), (WIDTH // 2, HEIGHT - CENTER_POCKET_DIST), (WIDTH - SIDE_POCKET_DIST, HEIGHT - SIDE_POCKET_DIST)]) * ZOOM_MULTIPLIER).astype(int)
