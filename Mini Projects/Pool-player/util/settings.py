...
SIDE_POCKET_BOUNDARY = (np.array([(DIST_FROM_EDGE_TO_RAIL, SIDE_POCKET_HEIGHT + DIST_FROM_EDGE_TO_RAIL), (WIDTH / 2 - SIDE_POCKET_DIAMETER / 2, DIST_FROM_EDGE_TO_RAIL), (WIDTH / 2 + SIDE_POCKET_DIAMETER / 2, DIST_FROM_EDGE_TO_RAIL), (WIDTH - DIST_FROM_EDGE_TO_RAIL, SIDE_POCKET_HEIGHT + DIST_FROM_EDGE_TO_RAIL), (WIDTH - DIST_FROM_EDGE_TO_RAIL, HEIGHT - (SIDE_POCKET_HEIGHT + DIST_FROM_EDGE_TO_RAIL)), (WIDTH / 2 + SIDE_POCKET_DIAMETER / 2, HEIGHT - DIST_FROM_EDGE_TO_RAIL), (WIDTH / 2 - SIDE_POCKET_DIAMETER / 2, HEIGHT - DIST_FROM_EDGE_TO_RAIL), (DIST_FROM_EDGE_TO_RAIL, HEIGHT - (SIDE_POCKET_HEIGHT + DIST_FROM_EDGE_TO_RAIL))]) * ZOOM_MULTIPLIER).astype(int)
