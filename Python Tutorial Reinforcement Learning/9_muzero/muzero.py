...
class MuZero:
    ...
    Args:
        ...
        split_resources_in (int, optional): Split the GPU usage when using concurrent muzero instances.
    ...
    def __init__(self, game_name, config=None, split_resources_in=1):
        ...
        ray.init(num_gpus=total_gpus, ignore_reinit_error=True, log_to_driver=False)
