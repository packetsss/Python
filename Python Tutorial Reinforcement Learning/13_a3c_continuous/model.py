...
class A3C_CONV(torch.nn.Module):
    def __init__(self, num_inputs, action_space):
        ...
        num_outputs = action_space.shape[0] # action_space.n
    ...
    def forward(self, inputs):
        ...
        x = self.lrelu1(self.maxp1(self.conv1(x)))
        x = self.lrelu2(self.maxp2(self.conv2(x)))
        x = self.lrelu3(self.maxp3(self.conv3(x)))
        x = self.lrelu4(self.maxp4(self.conv4(x)))
