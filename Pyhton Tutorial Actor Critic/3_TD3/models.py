...
class CriticNetwork(keras.Model):
    def __init__(self, fc1_dims, fc2_dims, name, chkpt_dir=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'td3')):
...
class ActorNetwork(keras.Model):
    def __init__(self, fc1_dims, fc2_dims, n_actions, name, chkpt_dir=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'td3')):
