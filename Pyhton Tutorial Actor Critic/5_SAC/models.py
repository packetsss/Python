...
class CriticNetwork(keras.Model):
    def __init__(self, n_actions, fc1_dims=256, fc2_dims=256, name='critic', chkpt_dir=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'sac')):
...
class ValueNetwork(keras.Model):
    def __init__(self, fc1_dims=256, fc2_dims=256, name='value', chkpt_dir=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'sac')):
...
class ActorNetwork(keras.Model):
    def __init__(self, max_action, fc1_dims=256, fc2_dims=256, n_actions=2, name='actor', chkpt_dir=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'sac')):
